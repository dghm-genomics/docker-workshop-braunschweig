...
ARAGORN identifies tRNA and tmRNA genes and predicts tRNA secondary structure and is available from http://mbio-serv2.mbioekol.lu.se/ARAGORN/Downloads/. An introductory paper has been published in [Nucleic Acids Research](https://academic.oup.com/nar/article/32/1/11/1194008/ARAGORN-a-program-to-detect-tRNA-genes-and-tmRNA).
...
BBTools is a free and open-source suite of fast, multithreaded bioinformatics tools designed for analysis of DNA and RNA sequence data. Please visit http://jgi.doe.gov/data-and-tools/bbtools/ for a user guide.

### Barrnap

Barrnap predicts the location of ribosomal RNA genes in genomes of bacteria, archaea, mitochondria, and eukaryotes. It was created by Torsten Seemann, who has uploaded a manual at https://github.com/tseemann/barrnap/blob/master/README.md.

### HMMER

HMMER is used for searching sequence databases for sequence homologs, and for making sequence alignments. A user guide has been published at http://eddylab.org/software/hmmer3/3.1b2/Userguide.pdf.

### Infernal

Infernal ("INFERence of RNA ALignment") is for searching DNA sequence databases for RNA structure and sequence similarities. Visit the [Infernal Homepage](http://eddylab.org/infernal/) for further information. A user guide can be downloaded from http://eddylab.org/infernal/Userguide.pdf.

### Kaiju

Kaiju is a program for sensitive taxonomic classification of high-throughput sequencing reads from metagenomic whole genome sequencing experiments. Please refer to http://kaiju.binf.ku.dk/ for further information.
...
Parsnp is a command-line-tool for efficient microbial core genome alignment and SNP detection. Documentation is available at http://harvest.readthedocs.io/en/latest/.

### Prodigal

Prodigal (Prokaryotic Dynamic Programming Genefinding Algorithm) is a microbial (bacterial and archaeal) gene finding program developed at Oak Ridge National Laboratory and the University of Tennessee. Please visit the wiki page under https://github.com/hyattpd/prodigal/wiki for information about its usage.

### Prokka 

Prokka is a software tool created by Torsten Seemann for the rapid annotation of prokaryotic genomes. Visit the [Github page](https://github.com/tseemann/prokka) for information regarding its use.

### QUAST 

QUAST performs fast and convenient quality evaluation and comparison of genome assemblies. Please visit http://quast.sourceforge.net/ for further information. A web-accessible version is available at http://quast.bioinf.spbau.ru/.
...
Tbl2asn is a command-line program that automates the creation of sequence records for submission to GenBank. Information about its usage is available at https://www.ncbi.nlm.nih.gov/genbank/tbl2asn2/.
